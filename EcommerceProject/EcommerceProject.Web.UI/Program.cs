...
builder.Services.AddHttpClient<IProductService, ProductService>(); //additional
builder.Services.AddHttpClient<ICartService, CartService>(); //additional
...
SD.ProductAPIBase = builder.Configuration["ServiceUrls:ProductAPI"]; //additional
SD.ShoppingCartAPIBase = builder.Configuration["ServiceUrls:ShoppingCartAPI"]; //additional
...
builder.Services.AddScoped<ICartService, CartService>(); //additional
